 ...
 * @method \App\Model\Entity\Length newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\Length[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\Length|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\Length patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\Length[] patchEntities($entities, array $data, array $options = [])
