       ...
       style="background: url(<?= $url.'/files/SubCategories/category_logo/'.$subCategory->category_logo ?>");
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="breadcrumb-content text-center">
							<div class="title">
								<h2> <a href="/maincategories/<?= $subCategory->main_category->id?>"> <?=$subCategory->main_category->categoryname?> </a>   -->  <?=$subCategory->categoryname?></h2>
							</div>
